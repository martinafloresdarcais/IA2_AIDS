...
**Corso:** Intelligenza Artificiale 2  
**Autori:** Martina Flores d'Arcais, Lucio Valerio Mariani

Il progetto analizza il dataset ACTG 175 con l'obiettivo di predire l'esito clinico dei pazienti (`cid`: 1 = decesso/failure, 0 = censurato) tramite modelli di classificazione binaria. Sono stati implementati e confrontati quattro classificatori: Logistic Regression, Linear Discriminant Analysis, Gaussian Naive Bayes e MLP Neural Network, valutati con cross-validation stratificata a 5 fold e metriche adatte a dati sbilanciati (AUC-ROC, F1-score).
